 ...
 * bussiness   => BussinessValidationLayer
 * pms         => PMSValidationLayer
 * before_save => BeforeSaveValidationLayer
 * -----------------------------------------
 */
 ...
 *             'layer'   => 'pre|bussiness|pms|before_save',
 *             'code'    => 'error code',
 ...
 * and method name should be [pre|bussiness|pms|before_save]_[invalid|mandatory]_[field_name]
 */
